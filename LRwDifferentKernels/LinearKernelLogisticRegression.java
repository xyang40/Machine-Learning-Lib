...
public class LinearKernelLogisticRegression extends Predictor implements
		Serializable {
	...
	public LinearKernelLogisticRegression(double rate, int iterations) {
	...
	public void setAlpha_index_map(HashMap<Integer, Double> map) {
		this.alpha_index_map = map;
	}

	public HashMap<Integer, Double> getAlpha_index_map() {
		return this.alpha_index_map;
	}

	public HashMap<Integer, Instance> getSupport_vector_map() {
		return support_vector_map;
	}

	public void setSupport_vector_map(
			HashMap<Integer, Instance> support_vector_map) {
		this.support_vector_map = support_vector_map;
	}
}
